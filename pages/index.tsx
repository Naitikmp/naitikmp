    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="I'm Naitik Patel"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">I&apos;m Naitik Patel</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              {' '}
              Your friendly neighbourhood AI engineer and adept MERN stack developer.
              I spend my days (and often nights) pushing the boundaries of
              what AI can achieve and weaving dynamic web experiences,
              turning data and code into intelligent, interactive {' '}
            ...
            <motion.p {...getTransitions(0.5)}>
              ...
              A passionate tech enthusiast with an eye for detail and simplicity.
              When I'm not building innovative AI-driven applications or crafting
              seamless user interfaces, you can find me exploring cutting-edge
              research, delving into intriguing reads, or getting lost in the
              smooth rhythms of Pop & Hip hop. Feel free to{' '}
